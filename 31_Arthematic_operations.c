...
struct s {
 ...
 int main(){
	...
	FILE *fptr;
	int i;
	fptr=fopen("C:\\Users\\hp\\Desktop\\C_programs\\Sudhanshu_CPrograms0\\030_ReadWriteFile.txt","wb"); //Opening the file from the location.
	for (i=0;i<1;++i) {
		fflush(stdin);
		printf("Enter Text: ");
	...
	fclose(fptr);
	fptr=fopen("C:\\Users\\hp\\Desktop\\C_programs\\Sudhanshu_CPrograms0\\030_ReadWriteFile.txt","rb");
